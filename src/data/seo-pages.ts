...
export const seoPageDefinitions: SeoPageDefinition[] = [
  ...
  { path: "/subvention-renovation-quebec", title: "Subvention renovation Quebec : montants, admissibilite et estimation", description: "Estimer les aides possibles pour des travaux de renovation au Quebec et verifier comment maximiser le montant selon votre projet.", changeFrequency: "monthly", priority: 0.8, includeInHomeHub: true },
  ...
  { path: "/credit-solidarite-quebec", title: "Credit d'impot solidarite Quebec 2026", description: "Montants possibles, seuils, paiements et admissibilite du credit d'impot pour solidarite.", changeFrequency: "monthly", priority: 0.8 },
  { path: "/allocation-logement-quebec", title: "Allocation logement Quebec 2026", description: "Montant, admissibilite et demande d'allocation logement au Quebec.", changeFrequency: "monthly", priority: 0.85 },
  { path: "/supplement-revenu-garanti-2026", title: "Supplement de revenu garanti 2026", description: "Montants, tableau, seuils et admissibilite au SRG en 2026.", changeFrequency: "monthly", priority: 0.85, includeInHomeHub: true },
  { path: "/aide-sociale-quebec", title: "Aide sociale Quebec 2026", description: "Montants, demande, admissibilite et dates de depot de l'aide sociale au Quebec.", changeFrequency: "monthly", priority: 0.8, includeInHomeHub: true },
  ...
  { path: "/subvention-toiture-quebec", title: "Subvention toiture Quebec 2026 : aide pour refaire votre toit?", description: "Verifier les aides possibles avant de refaire une toiture au Quebec et eviter les erreurs avant de signer une soumission.", changeFrequency: "monthly", priority: 0.85 },
  ...
  { path: "/borne-recharge-quebec", title: "Subvention borne de recharge Quebec 2026", description: "Montant, formulaire et conditions pour une borne de recharge au Quebec.", changeFrequency: "monthly", priority: 0.75 },
  ...
  { path: "/retraite/combien-cotiser-reer", title: "Combien cotiser au REER Quebec", description: "Estimer combien cotiser a son REER selon le revenu, l'impot, les droits disponibles et la capacite d'epargne au Quebec.", changeFrequency: "monthly", priority: 0.85 },
  ...
  { path: "/prets-bourses-etudiants", title: "Prets et bourses etudiants Quebec 2026", description: "Guide des prets et bourses etudiants au Quebec : AFE, Bourse Perspective, REEP et remise de dette.", changeFrequency: "monthly", priority: 0.85, includeInHomeHub: true },
];
