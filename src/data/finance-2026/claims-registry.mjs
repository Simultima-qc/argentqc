...
export const claimsRegistry = [
  ...
  },
  {
    ...
    nextReviewAt: "2026-12-01",
    scopeNote:
      "Gouverné par l'issue #43 (audit source-backed ciblé), corrigé le 2026-09-03 suite à la revue indépendante de la PR #44. Aucun module finance-2026 dédié aux tranches d'imposition combinées, aux taux de retenue REER/FERR ou au crédit québécois âge/personne vivant seule/revenus de retraite n'existe encore; ledger seul, schéma classique. Corrections appliquées : seuil de récupération de la PSV aligné sur le ledger securite-vieillesse-quebec-2026 (93 454 $), taux de retenue à la source REER/FERR ajoutés, fourchette d'économies du fractionnement alignée sur le ledger fractionnement-revenu-retraite-2026 (2 000 $-10 000 $), mécanisme du crédit fédéral/québécois pour revenu de pension corrigé (mêmes claims que fractionnement-revenu-retraite-2026), crédit en raison de l'âge mis à jour aux montants 2026 primaires (fédéral 9 208 $ à 14 %, Québec 3 986 $ à 14 %, suite à la revue indépendante), condition d'âge du crédit pour la prolongation de carrière mise à jour (65 ans et plus depuis 2025) et montant aligné sur le dernier confirmé (1 750 $, 2025; 2026 indexé non confirmé). Maintien à domicile reste incertain (hors périmètre, article dédié).",
  },
  {
