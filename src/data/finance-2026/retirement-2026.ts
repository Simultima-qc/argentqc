...
export const retirementGuide2026 = defineVersionedDataset(
  "retirement-guide-2026",
  {
    ...
    status: "estimate",
    sourceNote: "Montants RRQ 2026 corriges selon les montants cles publies par Retraite Quebec. La rente reelle depend du dossier de cotisation et de l'age de demande.",
  ...
  },
  {
    rrqMontantsAge: [
      ...
      },
      {
        ...
        montantMax: "Plus eleve qu'a 65 ans selon le report",
    ...
    rrqVsRpc: [
      ...
      { aspect: "Montant maximum 2026", rrq: "1 507,65 $/mois a 65 ans", rpc: "~1 364 $/mois a 65 ans (avec bonification)" },
    ...
    rrqCotisations: [
      ...
      { salaire: "68 500 $+", cotEmpl: "~3 891 $", cotTot: "~7 782 $", renteEst: "Variable selon dossier a 65 ans" },
    ],
    rrqHighlights: [
