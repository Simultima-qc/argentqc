  ...
  },
  {
    ...
    offers: [
      ...
      },
      {
        ...
        contrat: null,
        conditions: {
          fr: "Nouveaux clients résidentiels au Québec, aux adresses admissibles. Crédit de 10 $/mois pendant 24 mois; prix sans ce crédit : 90 $/mois. Autopaiement par débit requis dans les 31 jours. Prix modifiable, taxes en sus. Installation : 0 $, ou 100 $ si vous refusez l’auto-installation disponible. Durée d’engagement non précisée sur la fiche Québec : à confirmer avant de commander. Plusieurs connexions sont nécessaires pour atteindre 1,5 Gbps; connexion filaire requise pour 940 Mbps en téléversement.",
          en: "New residential customers in Québec at eligible addresses. $10/month credit for 24 months; price without this credit: $90/month. Automatic debit payments required within 31 days. Price may increase; taxes extra. Installation: $0, or $100 if you decline available self-installation. The Québec product page does not specify the contract term: confirm it before ordering. Multiple connections are needed for 1.5 Gbps; a wired connection is required for 940 Mbps upload.",
        },
        modemInclus: true,
        regions: ["Province entiere"],
        url: "https://www.bell.ca/Services_Internet/Acces_Internet",
