...
export const metadata: Metadata = {
  title: "Assurances au QuÃ©bec â€” Guide complet 2026 | ArgentQC.ca",
  description:
    "Guide complet des assurances au QuÃ©bec en 2026 : auto (rÃ©gime mixte SAAQ/privÃ©), habitation, vie et invaliditÃ©. Comment comparer les assureurs et Ã©viter les erreurs courantes.",
  keywords: [
    "assurance QuÃ©bec",
    "comparateur assurance QuÃ©bec",
    "types assurance QuÃ©bec",
    "assurance auto habitation QuÃ©bec 2026",
  ],
};
...
const typesAssurance = [
  {
    ...
    emoji: "ðŸš—",
    obligatoire: true,
    desc: "Obligatoire pour tout vÃ©hicule immatriculÃ©. RÃ©gime mixte unique au QuÃ©bec : la SAAQ couvre les dommages corporels, un assureur privÃ© couvre les dommages matÃ©riels.",
    href: "/assurances/auto",
    cta: "Guide assurance auto â†’",
  },
  {
    type: "Assurance habitation",
    emoji: "ðŸ ",
    obligatoire: false,
    desc: "Non obligatoire lÃ©galement, mais fortement recommandÃ©e (et souvent exigÃ©e par le propriÃ©taire). Couvre les dommages Ã  vos biens et votre responsabilitÃ© civile.",
    href: "/assurances/habitation",
    cta: "Guide assurance habitation â†’",
  },
  {
    type: "Assurance vie",
    emoji: "â¤ï¸",
    obligatoire: false,
    desc: "ProtÃ¨ge vos proches en cas de dÃ©cÃ¨s. RecommandÃ©e dÃ¨s que vous avez des dÃ©pendants (enfants, conjoint) ou des dettes importantes (hypothÃ¨que).",
    href: "/assurances/vie",
    cta: "Guide assurance vie â†’",
  },
  {
    type: "Assurance invaliditÃ©",
    emoji: "ðŸ©º",
    obligatoire: false,
    desc: "Remplace une partie de vos revenus si vous ne pouvez plus travailler. Souvent offerte par les employeurs. Les travailleurs autonomes doivent s'en procurer une eux-mÃªmes.",
    href: null,
    cta: null,
  },
];
...
const erreurs = [
  {
    ...
    detail: "La plupart des gens ne lisent jamais leur contrat. RÃ©sultat : des surprises au moment d'une rÃ©clamation. Prenez 30 minutes pour connaÃ®tre vos exclusions.",
    emoji: "ðŸ“„",
  },
  {
    erreur: "Sous-assurer ses biens",
    detail: "Beaucoup de locataires sous-estiment la valeur de leurs effets personnels. Un ordinateur, un vÃ©lo, une tÃ©lÃ©vision, des vÃªtements â€” Ã§a monte vite Ã  20 000â€“30 000 $.",
    emoji: "ðŸ“‰",
  },
  {
    erreur: "NÃ©gliger l'assurance invaliditÃ©",
    detail: "Le risque d'Ãªtre invalide avant 65 ans est plus Ã©levÃ© que le risque de dÃ©cÃ©der. La CNESST ne couvre que les accidents du travail â€” pas les maladies.",
    emoji: "âš ï¸",
  },
  {
    erreur: "Ne pas magasiner Ã  chaque renouvellement",
    detail: "Les assureurs rÃ©compensent rarement la fidÃ©litÃ©. Obtenir 3 soumissions Ã  chaque renouvellement peut Ã©conomiser 200â€“600 $/an.",
    emoji: "ðŸ’°",
  },
  {
    erreur: "Ignorer le rÃ©gime SAAQ pour l'auto",
    detail: "Au QuÃ©bec, les dommages corporels en cas d'accident sont TOUJOURS couverts par la SAAQ â€” peu importe qui est Ã  blÃ¢me. Beaucoup de QuÃ©bÃ©cois ne le savent pas.",
    emoji: "ðŸš—",
  },
];
...
const faqs = [
  {
    q: "Quelle est la particularitÃ© du rÃ©gime d'assurance auto au QuÃ©bec ?",
    r: "Le QuÃ©bec est la seule province canadienne avec un rÃ©gime mixte : la SAAQ (gouvernement) couvre obligatoirement tous les dommages corporels pour toute personne impliquÃ©e dans un accident automobile, peu importe la faute. Un assureur privÃ© couvre sÃ©parÃ©ment les dommages matÃ©riels (votre vÃ©hicule, les autres vÃ©hicules et les biens). Ce rÃ©gime Ã©limine les poursuites civiles pour dommages corporels liÃ©s Ã  l'automobile.",
  },
  {
    q: "Vaut-il mieux passer par un courtier ou acheter directement chez un assureur ?",
    r: "Un courtier d'assurance reprÃ©sente plusieurs assureurs et peut comparer les prix pour vous â€” c'est gratuit (ils sont rÃ©munÃ©rÃ©s par les assureurs). Acheter directement (Intact Direct, Desjardins en ligne) peut parfois Ãªtre moins cher, mais vous devez comparer vous-mÃªme. Pour une premiÃ¨re assurance ou une situation complexe, le courtier est souvent avantageux.",
  },
  {
    q: "Dois-je avoir une assurance habitation si je suis locataire ?",
    r: "LÃ©galement, non â€” un locataire n'est pas obligÃ© d'avoir une assurance habitation. Mais la plupart des propriÃ©taires l'exigent dans le bail. Surtout, en cas de sinistre (incendie, dÃ©gÃ¢t des eaux), sans assurance vous perdez tous vos biens sans compensation. Le coÃ»t moyen pour un locataire est de 25â€“40 $/mois â€” une protection essentielle pour peu cher.",
  },
  {
    q: "Quand faut-il revoir ses assurances ?",
    r: "Ã€ chaque renouvellement (annuel), mais aussi lors de changements de vie importants : achat d'une propriÃ©tÃ©, dÃ©mÃ©nagement, naissance d'un enfant, achat d'un vÃ©hicule, rÃ©novations importantes, ou changement de situation professionnelle (travailleur autonome).",
  },
];
    ...
    <main className="min-h-screen" style={{ background: PARCH }}>
      ...
      <section style={{ background: DARK, position: "relative", overflow: "hidden" }} className="px-5 py-12">
        ...
        <div className="max-w-2xl mx-auto" style={{ position: "relative", zIndex: 1 }}>
          ...
          <p style={{ color: GOLD, fontSize: "11px", fontWeight: 700, letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: "12px", opacity: 0.8 }}>
            Guide complet Â· Assurances QuÃ©bec 2026
          </p>
          <h1 style={{ fontFamily: "var(--font-playfair)", color: "#F0EBE0", fontSize: "clamp(1.6rem, 5vw, 2.2rem)", fontWeight: 800, lineHeight: 1.2, marginBottom: "12px" }}>
            Assurances au QuÃ©bec â€” Guide complet 2026
          </h1>
          <p style={{ color: "rgba(240,235,224,0.6)", fontSize: "14px", lineHeight: 1.7 }}>
            Auto, habitation, vie, invaliditÃ© â€” tout ce qu&apos;il faut savoir sur les assurances au QuÃ©bec,
            incluant la spÃ©cificitÃ© unique du rÃ©gime mixte SAAQ/privÃ© pour l&apos;automobile.
          </p>
        </div>
      </section>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.4rem", fontWeight: 800, color: "#1C1C1E", marginBottom: "1.25rem" }}>
          Les types d&apos;assurance au QuÃ©bec
        </h2>
        ...
        <div style={{ background: "#EFF6FF", border: "1px solid #BFDBFE", borderRadius: "16px", padding: "1.25rem", marginBottom: "2.5rem" }}>
          <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.2rem", fontWeight: 800, color: "#1E40AF", marginBottom: "12px" }}>
            ðŸš— La particularitÃ© quÃ©bÃ©coise : le rÃ©gime SAAQ/privÃ©
          </h2>
          <p style={{ fontSize: "13px", color: "#1E40AF", lineHeight: 1.7, marginBottom: "12px" }}>
            Le QuÃ©bec est la <strong>seule province canadienne</strong>{" "}avec un rÃ©gime d&apos;assurance automobile mixte. Voici comment Ã§a fonctionne :
          </p>
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "12px", background: "white", borderRadius: "10px", overflow: "hidden" }}>
              <thead>
                <tr style={{ background: "#1E40AF", color: "white" }}>
                  ...
                  <th style={{ padding: "9px 12px", textAlign: "left", fontWeight: 700 }}>DÃ©tail</th>
                </tr>
              </thead>
              <tbody>
                <tr style={{ borderBottom: "1px solid #EFF6FF" }}>
                  ...
                  <td style={{ padding: "9px 12px", color: "#44403C" }}>Blessures Ã  vous, aux passagers, aux piÃ©tons â€” peu importe la faute</td>
                </tr>
                <tr style={{ borderBottom: "1px solid #EFF6FF" }}>
                  <td style={{ padding: "9px 12px", fontWeight: 600, color: "#1C1C1E" }}>Dommages matÃ©riels</td>
                  <td style={{ padding: "9px 12px", textAlign: "center" }}><span style={{ background: "#FEF3C7", color: "#92400E", fontWeight: 700, padding: "2px 8px", borderRadius: "100px" }}>Assureur privÃ©</span></td>
                  <td style={{ padding: "9px 12px", color: "#44403C" }}>Votre vÃ©hicule, les autres vÃ©hicules, les biens endommagÃ©s</td>
                </tr>
                <tr>
                  <td style={{ padding: "9px 12px", fontWeight: 600, color: "#1C1C1E" }}>ResponsabilitÃ© civile</td>
                  <td style={{ padding: "9px 12px", textAlign: "center" }}><span style={{ background: "#FEF3C7", color: "#92400E", fontWeight: 700, padding: "2px 8px", borderRadius: "100px" }}>Assureur privÃ©</span></td>
                  <td style={{ padding: "9px 12px", color: "#44403C" }}>Protection si vous causez des dommages matÃ©riels Ã  autrui (min. 50 000 $)</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p style={{ fontSize: "12px", color: "#3730A3", marginTop: "10px", lineHeight: 1.6 }}>
            ConsÃ©quence importante : au QuÃ©bec, <strong>personne ne peut poursuivre civilement pour dommages corporels</strong>{" "}liÃ©s Ã  un accident de voiture. La SAAQ indemnise tout le monde.
          </p>
        </div>

        {/* Courtier vs direct */}
        <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.4rem", fontWeight: 800, color: "#1C1C1E", marginBottom: "1.25rem" }}>
          Courtier vs achat direct â€” Quoi choisir ?
        </h2>
        <div className="grid grid-cols-1 gap-4 mb-10" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
          <div style={{ background: "white", border: "2px solid #A7F3D0", borderRadius: "16px", padding: "1.25rem" }}>
            <h3 style={{ fontWeight: 800, fontSize: "15px", color: "#065F46", marginBottom: "10px" }}>ðŸ¤ Courtier d&apos;assurance</h3>
            <ul style={{ margin: 0, paddingLeft: "1.1rem", fontSize: "13px", color: "#044F3C", lineHeight: 1.75 }}>
              <li>ReprÃ©sente plusieurs assureurs</li>
              <li>Compare les prix pour vous</li>
              <li>Service gratuit (rÃ©munÃ©rÃ© par les assureurs)</li>
              <li>Conseils personnalisÃ©s</li>
              <li>IdÃ©al pour situations complexes</li>
            </ul>
          </div>
          <div style={{ background: "white", border: "2px solid #BFDBFE", borderRadius: "16px", padding: "1.25rem" }}>
            <h3 style={{ fontWeight: 800, fontSize: "15px", color: "#1E40AF", marginBottom: "10px" }}>ðŸ’» Achat direct (en ligne)</h3>
            <ul style={{ margin: 0, paddingLeft: "1.1rem", fontSize: "13px", color: "#1E3A8A", lineHeight: 1.75 }}>
              ...
              <li>LimitÃ© Ã  un seul assureur</li>
              <li>Vous devez comparer vous-mÃªme</li>
            </ul>
          </div>
        </div>
        ...
        {/* Erreurs courantes */}
        <h2 style={{ fontFamily: "var(--font-playfair)", fontSize: "1.4rem", fontWeight: 800, color: "#1C1C1E", marginBottom: "1.25rem" }}>
          5 erreurs courantes des QuÃ©bÃ©cois en assurance
        </h2>
        ...
        <Link href="/assurances/comparateur" style={{ display: "flex", alignItems: "center", gap: "12px", background: DARK, border: "1px solid rgba(245,200,66,0.2)", borderRadius: "14px", padding: "14px 16px", textDecoration: "none", marginBottom: "2.5rem" }}>
          ...
          <div className="flex-1">
            <div style={{ fontWeight: 700, fontSize: "14px", color: "#F0EBE0" }}>Comparer les assureurs au QuÃ©bec</div>
            <div style={{ fontSize: "12px", color: "rgba(240,235,224,0.5)", marginTop: "2px" }}>Estimations habitation et auto par profil â€” 6 assureurs comparÃ©s</div>
          </div>
          <span style={{ color: GOLD, fontSize: "14px" }}>â†’</span>
        </Link>
        ...
        <div className="grid grid-cols-1 gap-4 mb-10" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(260px, 1fr))" }}>
          <Link href="/assurances/auto" style={{ display: "block", background: DARK, borderRadius: "16px", padding: "1.25rem", textDecoration: "none" }}>
            ...
            <p style={{ color: "rgba(240,235,224,0.6)", fontSize: "12px", lineHeight: 1.6, marginBottom: "12px" }}>
              Fonctionnement SAAQ/privÃ©, prix moyens par profil, 7 conseils pour Ã©conomiser.
            </p>
            <span style={{ color: GOLD, fontWeight: 700, fontSize: "13px" }}>Lire le guide â†’</span>
          </Link>
          <Link href="/assurances/habitation" style={{ display: "block", background: "white", border: "1px solid #EDE9E0", borderRadius: "16px", padding: "1.25rem", textDecoration: "none" }}>
            ...
            <p style={{ color: "#78716C", fontSize: "12px", lineHeight: 1.6, marginBottom: "12px" }}>
              Locataire vs propriÃ©taire, ce qui est couvert, prix moyens par type de logement.
            </p>
            <span style={{ color: "#3B82F6", fontWeight: 700, fontSize: "13px" }}>Lire le guide â†’</span>
          </Link>
          <Link href="/assurances/vie" style={{ display: "block", background: "white", border: "1px solid #EDE9E0", borderRadius: "16px", padding: "1.25rem", textDecoration: "none" }}>
            ...
            <p style={{ color: "#78716C", fontSize: "12px", lineHeight: 1.6, marginBottom: "12px" }}>
              Temporaire vs permanente, principaux assureurs, estimateur de couverture personnalisÃ©.
            </p>
            <span style={{ color: "#3B82F6", fontWeight: 700, fontSize: "13px" }}>Lire le guide â†’</span>
          </Link>
        </div>
        ...
        <Link href="/demenagement/cout" style={{ display: "flex", alignItems: "center", gap: "12px", background: "white", border: "1px solid #EDE9E0", borderRadius: "14px", padding: "14px 16px", textDecoration: "none", marginBottom: "1rem" }}>
          ...
          <div className="flex-1">
            <div style={{ fontWeight: 700, fontSize: "14px", color: "#1C1C1E" }}>Vous dÃ©mÃ©nagez ? Pensez Ã  votre assurance habitation</div>
            <div style={{ fontSize: "12px", color: "#A8A29E" }}>Ã€ souscrire avant d&apos;entrer dans votre nouveau logement</div>
          </div>
      ...
      <footer style={{ background: DARK, padding: "24px 16px" }}>
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p style={{ color: "rgba(240,235,224,0.3)", fontSize: "11px" }}>Outil informatif non affiliÃ© aux assureurs ou au gouvernement.</p>
