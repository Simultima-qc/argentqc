  ...
  return (
    <main className="min-h-screen bg-slate-50">
      ...
      <article className="max-w-2xl mx-auto px-4 py-10">
        ...
        <div className="bg-blue-700 text-white rounded-2xl p-6 text-center mb-6">
          <p className="font-bold text-lg mb-2">Découvrez toutes vos aides en 2 minutes</p>
          <p className="text-blue-200 text-sm mb-4">Frais de garde, allocation famille, ACE — calculez tout ce à quoi vous avez droit.</p>
          <Link
            href="/questionnaire"
