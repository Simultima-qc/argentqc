    ...
    <main className="min-h-screen" style={{ background: PARCH }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-3 mb-8">
          ...
          <Link href="/fr/budget/calculateur" style={{ display: "flex", alignItems: "center", gap: "12px", background: "white", border: "1px solid #EDE9E0", borderRadius: "14px", padding: "14px 16px", textDecoration: "none" }}>
            <span style={{ fontSize: "1.5rem" }}>📊</span>
            <div className="flex-1">
          ...
          <Link href="/fr/demenagement/checklist" style={{ display: "flex", alignItems: "center", gap: "12px", background: "white", border: "1px solid #EDE9E0", borderRadius: "14px", padding: "14px 16px", textDecoration: "none" }}>
            <span style={{ fontSize: "1.5rem" }}>✅</span>
            <div className="flex-1">
