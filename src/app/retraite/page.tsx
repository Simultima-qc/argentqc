...
const startSteps = [
  {
    ...
    links: [
      { href: "/fr/retraite/celiapp", label: "Voir le CELIAPP" },
      { href: "/fr/retraite/reer", label: "Voir le REER" },
    ],
  },
  {
    step: "2",
    ...
    links: [
      ...
      { href: "/fr/retraite/reer", label: "Guide REER" },
      { href: "/fr/retraite/celi", label: "Guide CELI" },
    ],
  },
  {
    step: "3",
    ...
    links: [{ href: "/fr/questionnaire", label: "Voir ma stratégie" }],
  },
];
            ...
            <div className="grid gap-8 md:grid-cols-[1.25fr_0.75fr] md:items-end">
              <div>
                ...
                <p className="mb-6 max-w-2xl text-base leading-7 text-slate-300">
                  Le bon ordre entre{" "}
                  <Link href="/fr/retraite/reer" className="font-bold text-yellow-300 underline">
                    REER
                  </Link>
                  ,{" "}
                  <Link href="/fr/retraite/celi" className="font-bold text-yellow-300 underline">
                    CELI
                  </Link>{" "}
                  et{" "}
                  <Link href="/fr/retraite/celiapp" className="font-bold text-yellow-300 underline">
                    CELIAPP
                  </Link>{" "}
