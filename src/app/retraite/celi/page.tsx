    ...
    <main className="min-h-screen" style={{ background: PARCH }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-3 mb-4">
          {[
            { href: "/retraite/reer-vs-celi", emoji: "⚖️", titre: "REER ou CELI — Comparatif", desc: "Comparer les deux comptes selon revenu, projets et flexibilité" },
            { href: "/fr/retraite/reer", emoji: "💰", titre: "REER — Guide complet", desc: "Comparer REER et CELI, plafond 2026, économies d'impôt" },
            { href: "/fr/retraite/celiapp", emoji: "🏡", titre: "CELIAPP vs CELI →", desc: "Différences clés, règles d'admissibilité et stratégie combinée" },
            { href: "/fr/retraite/rrq", emoji: "🏛️", titre: "RRQ — Votre rente de retraite", desc: "Montants et impact du choix de l'âge de retraite" },
