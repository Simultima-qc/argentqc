    ...
    <main className="min-h-screen" style={{ background: PARCH }}>
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="flex flex-col gap-3 mb-4">
          {[
            { href: "/fr/impots/dates", emoji: "📅", titre: "Dates limites impôts 2026", desc: "30 avril pour les salariés — ne manquez pas la date" },
            { href: "/fr/impots/remboursement", emoji: "💰", titre: "Maximiser votre remboursement", desc: "Crédits souvent oubliés + délais de réception" },
            { href: "/fr/impots", emoji: "📋", titre: "Guide impôts Québec 2026", desc: "ARC vs Revenu Québec — tout comprendre" },
          ].map((l) => (
      ...
      <SiteFooter
        legalText={"Outil informatif non affilié aux logiciels mentionnés. Vérifiez les conditions d'utilisation et les tarifs directement auprès des éditeurs."}
