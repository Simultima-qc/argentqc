  ...
  return (
    <>
      ...
      <main style={{ background: PARCH, minHeight: "100vh" }}>
        ...
        <SiteFooter
          legalText={"Outil informatif non affilié au gouvernement. Les montants sont des estimations — consultez les sites officiels et un planificateur financier pour votre situation spécifique."}
