...
const fr: BudgetSolidarityCreditDictionary = {
  ...
  programmes: [
    ...
    },
    {
      ...
      description:
        "Aide mensuelle pour les locataires et proprietaires-occupants a faible revenu qui consacrent une trop grande part de leurs revenus au logement.",
      conditions: [
  ...
  programmes: [
    ...
    },
    {
      ...
      conditions: [
        ...
        "Meet the applicable income and savings thresholds",
      ],
      lien_officiel: "https://www.revenuquebec.ca/fr/citoyens/votre-situation/faible-revenu/programme-allocation-logement/",
      criteres: { provinces: ["QC"], revenu_max: 46640 },
    },
