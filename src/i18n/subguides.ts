...
const frInsuranceHome: InsuranceHomeDictionary = {
  ...
  pricingRows: [
    ...
    { housing: "Condo propriétaire occupant", insuredValue: "Unité + biens", monthlyPremium: "60 a 120 $", note: "La police du syndicat ne remplace pas la protection individuelle." },
    { housing: "Maison unifamiliale", insuredValue: "Bâtiment + biens", monthlyPremium: "100 a 220 $", note: "Le coût dépend beaucoup de la valeur de reconstruction et du secteur." },
  ],
