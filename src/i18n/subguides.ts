...
const frRetirementFhsa: RetirementFhsaDictionary = {
  ...
  strategyRows: [
    ...
    { label: "RAP - retrait REER (par personne)", value: "60 000 $" },
  ],
  strategyTotalLabel: "Couple - total combiné",
  strategyTotalValue: "200 000 $",
  ...
  comparisonRows: [
    ...
    { criteria: "Plafond annuel", fhsa: "8 000 $", tfsa: "7 000 $ (2026)", rrsp: "18% du revenu (max 33 810 $)" },
...
const enRetirementFhsa: RetirementFhsaDictionary = {
  ...
  strategyRows: [
    ...
    { label: "Home Buyers' Plan RRSP withdrawal (per person)", value: "CAD 60,000" },
  ],
  strategyTotalLabel: "Couple - combined total",
  strategyTotalValue: "CAD 200,000",
  ...
  comparisonRows: [
    ...
    { criteria: "Annual room", fhsa: "CAD 8,000", tfsa: "CAD 7,000 (2026)", rrsp: "18% of income (max CAD 33,810)" },
...
const frRetirementRrsp: RetirementRrspDictionary = {
  ...
  specialUses: [
    { title: "RAP", points: ["Jusqu'a 60 000 $ par personne", "Utilisable pour un premier achat admissible", "Remboursement sur 15 ans"] },
  ...
  faqsTitle: "Questions fréquentes",
  faqs: [
    { question: "Quel est le plafond REER 2026 ?", answer: "Le maximum général 2026 est de 33 810 $, sous réserve de votre espace personnel et du 18% de revenu gagné." },
...
const enRetirementRrsp: RetirementRrspDictionary = {
  ...
  specialUses: [
    { title: "Home Buyers' Plan", points: ["Up to 60,000 CAD per person", "Useful for an eligible first home purchase", "Repayment over 15 years"] },
  ...
  faqsTitle: "Frequently asked questions",
  faqs: [
    { question: "What is the 2026 RRSP limit?", answer: "The general 2026 maximum is 33,810 CAD, subject to your personal room and the 18% earned-income rule." },
