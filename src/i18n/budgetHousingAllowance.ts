...
const fr: BudgetHousingAllowanceDictionary = {
  routeKey: "budgetHousingAllowance",
  metadata: {
    title: "Allocation logement Québec 2026 : jusqu’à 170 $/mois",
    description:
      "Voyez le montant de l’allocation logement au Québec, les critères d’admissibilité, les démarches et quoi vérifier avant de faire une demande.",
  },
  keyword: "Allocation logement Québec 2026",
  title: "Allocation logement Québec 2026",
  subtitle: "Montants possibles, critères d’admissibilité, demande et documents à préparer pour vérifier votre droit.",
  intro:
    "Réponse rapide : l’allocation logement Québec 2026 vise les ménages à faible revenu pour qui le coût du logement pèse lourd dans le budget. L’admissibilité dépend du revenu, du loyer, de la composition du ménage et de certaines conditions liées à l’âge ou aux enfants à charge. Vérifiez le montant exact sur le site officiel avant de déposer votre demande.",
  totalLabel: "Potentiel total des aides connexes",
  availableProgramsLabel: "programmes disponibles",
  programsTitle: "Allocation logement et aides connexes",
  faqsTitle: "Questions fréquentes",
  relatedTitle: "Pages reliées",
  ctaTitle: "Voir toutes les aides liées au budget",
  ctaText: "Le questionnaire permet de croiser logement, revenu, famille et autres leviers budgétaires en quelques minutes.",
  ctaLabel: "Commencer le questionnaire",
  ctaHint: "Gratuit · 2 minutes · estimation personnalisée",
  disclaimer:
  ...
  relatedLinks: [
    { href: "/aides-financieres/logement", title: "Toutes les aides au logement au Québec" },
    { href: "/fr/budget/credit-solidarite", title: "Crédit de solidarité Québec" },
  ...
  programmes: [
    ...
    },
    {
      ...
      description:
        "Credit remboursable distinct de l'allocation-logement : composante logement selon l'annexe D (releve 31 pour les locataires), en plus des composantes TVQ et village nordique. Montant et frequence determines par Revenu Quebec.",
      conditions: [
        "Resider au Quebec au 31 decembre 2025",
        "Produire la declaration de revenus 2025 et l'annexe D",
        "Faire verifier le montant par Revenu Quebec",
      ],
...
const en: BudgetHousingAllowanceDictionary = {
  ...
  programmes: [
    ...
    },
    {
      ...
      preselection_only: true,
      description:
        "Refundable credit distinct from the housing allowance: a housing component based on Schedule D (a Relevé 31 for renters), plus sales tax and northern village components. Amount and frequency are set by Revenu Quebec.",
      conditions: [
        "Live in Quebec on December 31, 2025",
        "File your 2025 tax return and Schedule D",
        "Have Revenu Quebec verify the amount",
      ],
      lien_officiel: "https://www.revenuquebec.ca/fr/citoyens/credits-dimpot/credit-dimpot-pour-solidarite/",
      criteres: { provinces: ["QC"] },
    },
