  ...
  budget: {
    ...
    example: {
      ...
      items: [
        ...
        { label: "Crédit de solidarité (locataire)", amount: "À vérifier" },
      ],
      totalLabel: "Sous-total illustratif (hors crédit de solidarité)",
      totalAmount: "920 $/an",
    },
    actionSteps: [
  ...
  taxes: {
    ...
    example: {
      ...
      items: [
        ...
        { label: "Crédit de solidarité Québec (locataire)", amount: "À vérifier" },
        { label: "Remboursement REER cotisé (8 000 $)", amount: "+ 2 560 $" },
        { label: "Crédit d'impôt frais médicaux", amount: "+ 320 $" },
      ],
      totalLabel: "Sous-total illustratif (hors ACEBE et crédit de solidarité)",
      totalAmount: "2 880 $",
    },
    actionSteps: [
  ...
  budget: {
    ...
    example: {
      ...
      items: [
        ...
        { label: "Solidarity tax credit (renter)", amount: "Verify" },
      ],
      totalLabel: "Illustrative subtotal (excluding the solidarity tax credit)",
      totalAmount: "$920/yr",
    },
    actionSteps: [
  ...
  taxes: {
    ...
    example: {
      ...
      items: [
        ...
        { label: "Quebec solidarity credit (renter)", amount: "Verify" },
        { label: "RRSP refund on $8,000 contribution", amount: "+ $2,560" },
        { label: "Medical expense tax credit", amount: "+ $320" },
      ],
      totalLabel: "Illustrative subtotal (excluding CGEB and the solidarity tax credit)",
      totalAmount: "$2,880",
    },
    actionSteps: [
